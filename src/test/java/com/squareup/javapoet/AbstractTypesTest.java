...
public abstract class AbstractTypesTest {
    ...
    public void getTypeVariableTypeMirrorRecursive() {
        ...
        assertThat(typeVariableName).hasToString("T");
        assertThat(typeVariableName.bounds)
                .hasToString("[java.util.Map<java.util.List<T>, java.util.Set<T[]>>]");
    }
    ...
    public void parameterizedType() {
        ...
        assertThat(type).hasToString("java.util.Map<java.lang.String, java.lang.Long>");
    }

    @Test
    public void arrayType() {
        ArrayTypeName type = ArrayTypeName.of(String.class);
        assertThat(type).hasToString("java.lang.String[]");
    }
    ...
    public void wildcardSuperType() {
        ...
        assertThat(type).hasToString("? super java.lang.String");
    }
    ...
    public void typeVariable() {
        ...
        assertThat(type).hasToString("T"); // (Bounds are only emitted in declaration.)
    }
    ...
    public void unbox() {
        ...
        assertThrows(UnsupportedOperationException.class, () -> TypeName.OBJECT.unbox());
        assertThrows(UnsupportedOperationException.class, () -> ClassName.get(String.class).unbox());
    }
}
