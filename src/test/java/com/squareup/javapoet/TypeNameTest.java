...
public class TypeNameTest {
    ...
    public void innerClassInGenericType() throws Exception {
        ...
        assertThat(TypeName.get(genericStringInner.getGenericReturnType())).isNotEqualTo(
    ...
    public void equalsAndHashCodeParameterizedTypeName() {
        ...
        assertThat(ClassName.get(List.class)).isNotEqualTo( ParameterizedTypeName.get(List.class,
                String.class));
    }
