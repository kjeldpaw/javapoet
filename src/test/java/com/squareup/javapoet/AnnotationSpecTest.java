...
final class AnnotationSpecTest {
    ...
    @Test
    void defaultAnnotation() throws Throwable {
    ...
    @Test
    void defaultAnnotationWithImport() throws Throwable {
        final var evaluatingProcessor = new EvaluatingProcessor((elements, types) -> {
            String name = IsAnnotated.class.getCanonicalName();
            TypeElement element = elements.getTypeElement(name);
            AnnotationSpec annotation = AnnotationSpec.get(element.getAnnotationMirrors().get(0));
    ...
    @Test
    void defaultAnnotationToBuilder() throws Throwable {
        final var evaluatingProcessor = new EvaluatingProcessor((elements, types) -> {
            String name = IsAnnotated.class.getCanonicalName();
            TypeElement element = elements.getTypeElement(name);
    ...
    static String toString(TypeSpec typeSpec) {
