...
final class JavaFileTest {

    @Test
    void importStaticReadmeExample() {
    ...
    @Test
    void importStaticForCrazyFormatsWorks() {
    ...
    @Test
    void importStaticUsingWildcards() {
        assertThat(JavaFile.builder("readme", importStaticTypeSpec("Util"))
    ...
    @Test
    void skipJavaLangImportsWithConflictingClassLast() {
    ...
    @Test
    void skipJavaLangImportsWithConflictingClassFirst() {
    ...
    @Test
    void conflictingNameOutOfScope() {
        String source = JavaFile.builder("com.squareup.tacos",
                        TypeSpec.classBuilder("A")
                                .addType(TypeSpec.classBuilder("B")
                                        .addType(TypeSpec.classBuilder("C")
    ...
    @Test
    void nestedClassAndSuperclassShareName() {
        String source = JavaFile.builder("com.squareup.tacos",
                        TypeSpec.classBuilder("Taco")
    ...
    @Test
    void classAndSuperclassShareName() {
        String source = JavaFile.builder("com.squareup.tacos",
                        TypeSpec.classBuilder("Taco")
    ...
    @Test
    void avoidClashesWithNestedClasses_viaTypeElement() throws Throwable{
        final var evaluatingProcessor = new EvaluatingProcessor((elements, types) -> {
            String source = JavaFile.builder("com.squareup.tacos",
                            TypeSpec.classBuilder("Taco")
                                    ...
                                    // This one shouldn't since we only look at nested types
                                    .addField(ClassName.get("other", "Foo"), "foo")
                                    .avoidClashesWithNestedClasses(elements.getTypeElement(Foo.class.getCanonicalName()))
                                    .build())
                    .build()
                    .toString();
            assertThat(source).isEqualTo(""
    ...
    @Test
    public void avoidClashes_parentChild_superclass_typeMirror() throws Throwable {
        final var evaluatingProcessor = new EvaluatingProcessor((elements, types) -> {
            String source = JavaFile.builder("com.squareup.javapoet",
                            childTypeBuilder().superclass(elements.getTypeElement(Parent.class.getCanonicalName()).asType()).build())
                    .build()
                    .toString();
            assertThat(source).isEqualTo("package com.squareup.javapoet;\n"
                    + "\n"
    ...
    @Test
    public void avoidClashes_parentChild_superinterface_typeMirror() throws Throwable {
        final var evaluatingProcessor = new EvaluatingProcessor((elements, types) -> {
        String source = JavaFile.builder("com.squareup.javapoet",
                        childTypeBuilder().addSuperinterface(elements.getTypeElement(ParentInterface.class.getCanonicalName()).asType()).build())
                .build()
                .toString();
        assertThat(source).isEqualTo("package com.squareup.javapoet;\n"
                + "\n"
