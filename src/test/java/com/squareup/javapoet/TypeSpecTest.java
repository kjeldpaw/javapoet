...
public final class TypeSpecTest {
    ...
    @Test
    public void typeFromTypeMirror() throws Throwable {
        final var evaluatingProcessor = new EvaluatingProcessor((elements, types) -> {
            TypeMirror mirror = elements.getTypeElement(String.class.getCanonicalName()).asType();
    ...
    @Test
    public void typeFromTypeElement() throws Throwable {
        final var evaluatingProcessor = new EvaluatingProcessor((elements, types) -> {
    ...
    @Test
    public void initializersToBuilder() throws Throwable {
        final var evaluatingProcessor = new EvaluatingProcessor((elements, types) -> {
            // Tests if toBuilder() contains correct static and instance initializers
            Element originatingElement = elements.getTypeElement(TypeSpecTest.class.getCanonicalName());
            TypeSpec taco = TypeSpec.classBuilder("Taco")
                    .addField(String.class, "foo", Modifier.PRIVATE)
                    .addField(String.class, "FOO", Modifier.PRIVATE, Modifier.STATIC, Modifier.FINAL)
                    .addStaticBlock(CodeBlock.builder()
